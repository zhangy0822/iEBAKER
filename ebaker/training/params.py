...
def parse_args():
    ...
    parser.add_argument(
        "--dropratio",default=0.01,type=float, required=True,
        help="drop ratio",
    )  
    parser.add_argument(
        "--dropepoch", default=4,type=int, required=True, 
        help="drop epoch",
    )     
    # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
    # Model Architechture
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Optional path to CLIP bpe_simple_vocab_16e6.txt.gz for keyword masked language modeling.",
    )
    parser.add_argument(
        "--keyword-file",
        type=str,
        default=None,
        help="Optional path to the merged keyword vocabulary. Defaults to ../keyword/merged_words.txt.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        choices=["joint", "split"],
        default="joint",
        help="Use the conference EBA-Joint mask or the journal EBA-Split global/local masks.",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to csv filewith retrieval data1",
    )
    parser.add_argument(
        "--retrieval-data1",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to csv filewith retrieval data2",
    )
    parser.add_argument(
        "--retrieval-data3",
        type=str,
        default=None,
        help="Path to csv filewith retrieval data3",
    )
    parser.add_argument(
