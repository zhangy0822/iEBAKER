...
def main():
    ...
    # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
    # Configurate distributed training and logging 分布式训练和记录
    # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
    ...
    if args.wandb and is_master(args):
        assert wandb is not None, 'Please install wandb or remove wandb from --report-to.'
    ...
    # Set barriers to avoid multiple downloads of pretrained weights 防止权重重复下载
    ...
    # Model Exponential Moving Average (only for evaluation now)只能评估时使用这个？
    model_ema = None
    if is_master(args):
        if args.model_ema:
    ...
    # Convert to sync BN and model DDP 这里也应该是并行的一些东西，不用看
    ...
    if is_master(args):
        ...
        logging.info(f"↓ Parameters to be optimized ↓")
        ...
        logging.info(f"↓ Parameters NOT to be optimized ↓")
        n_frozen_params = 0
        for n, p in named_parameters:
    ...
    # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
    # optionally resume from a checkpoint 断点继续训练
    # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
    ...
    # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
    # Save arguments and configurations 保存配置
    # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
